...
const Checkout = () => {
  ...
  const checkIn = (e) => {
    ...
    if (member !== undefined) {
      visits
        .filter((data) => data.memberid === techID)
  ...
  const displayCart = cart.map((item, index) => (
    <li key={index}>
      ...
      <div className="quantity">
        <span class="minus" onClick={() => decrement(index)}>
          -
        </span>
        <span>{item.quantity}</span>
        <span class="plus" onClick={() => increment(index)}>
          +
        </span>
      </div>
    </li>
      ...
      <div className="checkout-display">
        ...
        <div className="cart">
          ...
          <div className="button">
            <button className="btn" type="submit" onClick={clearCart}>
              Clear
            </button>
            <Popup
              trigger={
